package com.isla.kltn.Adapters;
...
import com.isla.kltn.Views.MonthView;
...
public class MonthViewPagerAdapter extends PagerAdapter {
    ...
    @VisibleForTesting
    public final List<MonthView> mViews = new ArrayList<>(getCount());
    @VisibleForTesting
    public long mSelectedDayMillis = CalendarUtils.today();
     ...
     */
    public void swapCursor(long monthMillis, @Nullable EventCursor cursor,
